        ...
        <div className="max-w-5xl mx-auto w-full px-4 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
            {[
              ...
              <Card
                key={idx}
                className="p-4 rounded-lg shadow-sm bg-white dark:bg-gray-800 hover:shadow-md transition"
              >
                {/* Header */}
                ...
                <div className="space-y-2">
                  {cat.items.map((item, i) => (
                    <div
                      key={i}
                      className="flex justify-between text-sm text-gray-700 dark:text-gray-300 border-t border-gray-200 dark:border-gray-700 pt-2"
                    >

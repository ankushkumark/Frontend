...
<<<<<<< HEAD
    ...
    >
      {/* Heading */}
      <h2 className="text-22px font-inter text-gray-600 dark:text-gray-300 mb-2">
        Total Balance
      </h2>

      <Card
        className="p-2 sm:p-3 rounded-lg bg-white dark:bg-gray-800 shadow-sm w-full cursor-pointer"
      ...
      >
        ...
        <div className="mt-2 flex items-center justify-between">
          <button
            ...
            className="flex items-center gap-1 text-xs text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white"
          >

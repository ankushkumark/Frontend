...
function useExpenses() {
    ...
    // update/save
    const saveExpense = async (key, amount)=>{
        if (!userId) return;
        try {
            const res = await fetch(`http://localhost:5000/api/expenses/${userId}/${key}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json"
                },
...
function ExpensesBreakdown() {
    const { expenses, saveExpense, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useExpenses$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])();
    ...
    const handleSave = async ()=>{
        if (!selectedItem || !newAmount) return;
        await saveExpense(selectedItem.title, newAmount);
...
//# sourceMappingURL=src_87c6309f._.js.map
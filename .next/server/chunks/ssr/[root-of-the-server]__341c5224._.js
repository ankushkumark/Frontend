...
"[project]/src/app/accounts/[id]/page.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
// ✅ Simple Modal for Editing Balance
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                    ...
                    fileName: "[project]/src/app/accounts/[id]/page.js",
                    lineNumber: 16,
                    columnNumber: 9
                }, this),
...
function AccountDetailsPage() {
    ...
    const accountId = params.id; // ✅ from dynamic route
    const userEmail = searchParams.get("email"); // ✅ query param (pass from AccountsPage)
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchData = async ()=>{
            try {
                ...
                const accRes = await fetch(`http://localhost:5000/api/accounts/id/${accountId}`);
                if (!accRes.ok) throw new Error("Account not found");
                const accData = await accRes.json();
                setAccount(accData);
                // ✅ 2. Fetch transactions by email
                if (userEmail) {
                    const txRes = await fetch(`http://localhost:5000/api/accounts/user/${userEmail}/transactions`);
                    if (txRes.ok) {
    ...
    // 💾 Save updated balance + transaction
    const handleSave = async ({ amount, type })=>{
        try {
            const res = await fetch(`http://localhost:5000/api/accounts/${accountId}/transaction`, {
                method: "POST",
                headers: {
            ...
            if (res.ok) {
                ...
                console.error("⚠️ Failed to save transaction");
            }
        } catch (err) {
            console.error("❌ Error saving transaction:", err);
        }
    };
    if (!account) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
        className: "p-6",
        children: "Loading..."
    }, void 0, false, {
        fileName: "[project]/src/app/accounts/[id]/page.js",
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    children: transactions.map((txn, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            className: "border-t",
                                            children: [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__341c5224._.js.map
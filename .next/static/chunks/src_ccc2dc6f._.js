...
function useExpenses() {
    ...
    const saveExpense = async (key, amount)=>{
        if (!userId) return;
        try {
            const res = await fetch("http://localhost:5000/api/expenses/".concat(userId, "/").concat(key), {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json"
                },
...
_s(useExpenses, "IEvafqKKi7LsHrucIJaYa6FqxLo=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function ExpensesBreakdown() {
    _s();
    const { expenses, saveExpense, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useExpenses$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
...
_s(ExpensesBreakdown, "lQDVtw3Lqc2PyB/q9a5RaqdmMqY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useExpenses$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
    ];
});
...
//# sourceMappingURL=src_ccc2dc6f._.js.map
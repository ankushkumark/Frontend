                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                            src: (user === null || user === void 0 ? void 0 : (_user_avatar = user.avatar) === null || _user_avatar === void 0 ? void 0 : _user_avatar.startsWith("http")) ? user.avatar : (user === null || user === void 0 ? void 0 : user.avatar) ? "http://localhost:5000/".concat(user.avatar) : "https://api.dicebear.com/7.x/initials/svg?seed=".concat((user === null || user === void 0 ? void 0 : user.name) || "User"),
...
function Header() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Header.useEffect": ()=>{
            ...
            if (!userId) return;
            fetch("http://localhost:5000/api/bills/user/".concat(userId)).then({
    ...
    const downloadData = async ()=>{
        try {
            ...
            //  Transactions fetch 
            const res = await fetch("http://localhost:5000/api/recent-transactions/".concat(userId));
            const data = await res.json();
...
function RecentTransactions() {
        ...
        "RecentTransactions.useEffect": ()=>{
            ...
            const fetchData = {
                "RecentTransactions.useEffect.fetchData": async ()=>{
                    try {
                        const res = await fetch("http://localhost:5000/api/recent-transactions/".concat(id));
                        if (!res.ok) {
    ...
    const handleSave = async ()=>{
        ...
        try {
            const res = await fetch("http://localhost:5000/api/recent-transactions/".concat(userId, "/").concat(selectedTx.title), {
                method: "PUT",
                headers: {
        ...
        "Statistics.useEffect": ()=>{
            async function fetchStats() {
                try {
                    ...
                    const res = await fetch("http://localhost:5000/api/stats/".concat(endpoint, "/").concat(userId));
...
_s(Home, "kLbw0djK0nKLThFjEyM87+KYkgk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"]
    ];
...
//# sourceMappingURL=src_d7e4e35f._.js.map